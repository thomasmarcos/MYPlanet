...
def main(context):
	if bpy.data.objects.get("Croute") is None:
	    ...
	    mat = bpy.data.materials.get("s_mercurycolor")
	    if mat is None:
	        mat = bpy.data.materials.append(name="s_mercurycolor")
...
class croute_mercurycolor(bpy.types.Operator):
	"""Tooltip"""
	bl_idname = "myops.croute_mercurycolor"
	bl_label = "s_mercurycolor"
...
def register():
	bpy.utils.register_class(croute_mercurycolor)

def unregister():
	bpy.utils.unregister_class(croute_mercurycolor)

if __name__ == "__main__":
	register()

	# test call
	# bpy.ops.myops.croute_mercurycolor()