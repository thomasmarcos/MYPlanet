...
def main(context):
	if bpy.data.objects.get("Croute") is None:
	    ...
	    mat = bpy.data.materials.get("s_neptune")
	    if mat is None:
	        mat = bpy.data.materials.append(name="s_neptune")
...
class croute_neptune(bpy.types.Operator):
	"""Tooltip"""
	bl_idname = "myops.croute_neptune"
	bl_label = "s_neptune"
...
def register():
	bpy.utils.register_class(croute_neptune)

def unregister():
	bpy.utils.unregister_class(croute_neptune)

if __name__ == "__main__":
	register()

	# test call
	# bpy.ops.myops.croute_neptune()