...
def main(context):
	if bpy.data.objects.get("Croute") is None:
	    ...
	    mat = bpy.data.materials.get("s_saturn")
	    if mat is None:
	        mat = bpy.data.materials.append(name="s_saturn")
...
class croute_saturn(bpy.types.Operator):
	"""Tooltip"""
	bl_idname = "myops.croute_saturn"
	bl_label = "s_saturn"
...
def register():
	bpy.utils.register_class(croute_saturn)

def unregister():
	bpy.utils.unregister_class(croute_saturn)

if __name__ == "__main__":
	register()

	# test call
	# bpy.ops.myops.croute_saturn()