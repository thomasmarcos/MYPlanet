...
def main(context):
	if bpy.data.objects.get("Croute") is None:
	    ...
	    mat = bpy.data.materials.get("s_moon")
	    if mat is None:
	        mat = bpy.data.materials.append(name="s_moon")
...
class croute_moon(bpy.types.Operator):
	"""Tooltip"""
	bl_idname = "myops.croute_moon"
	bl_label = "s_moon"
...
def register():
	bpy.utils.register_class(croute_moon)

def unregister():
	bpy.utils.unregister_class(croute_moon)

if __name__ == "__main__":
	register()

	# test call
	# bpy.ops.myops.croute_moon()