...
def main(context):
	if bpy.data.objects.get("Croute") is None:
	    ...
	    mat = bpy.data.materials.get("s_venus")
	    if mat is None:
	        mat = bpy.data.materials.append(name="s_venus")
...
class croute_venus(bpy.types.Operator):
	"""Tooltip"""
	bl_idname = "myops.croute_venus"
	bl_label = "s_venus"
...
def register():
	bpy.utils.register_class(croute_venus)

def unregister():
	bpy.utils.unregister_class(croute_venus)

if __name__ == "__main__":
	register()

	# test call
	# bpy.ops.myops.croute_venus()